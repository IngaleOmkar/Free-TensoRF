...
def config_parser(cmd=None):
    ...
    ## Addition for Free-TensoRF ##
    parser.add_argument('--freq', type=int, default=0, help='use frequency regularization')
    parser.add_argument('--occ', type=int, default=0, help='use occlusion regularization')
    ## End of addition ##
